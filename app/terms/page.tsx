      ...
      <main className="flex-1">
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-gray-900 leading-relaxed font-medium text-lg md:text-xl space-y-16">
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제1조 목적</h2>
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제2조 용어의 정의</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제3조 약관 외 준칙</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제4조 이용계약 체결</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제5조 서비스 이용 신청</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제6조 개인정보처리방침</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제7조 운영자의 의무</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제8조 회원의 의무</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제9조 서비스 이용 시간 및 중단</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제10조 서비스 이용 해지 및 제한</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제11조 게시물의 관리 및 저작권</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제12조 손해배상 및 면책</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">제13조 쿠폰 및 포인트</h2>
                <div className="space-y-4 text-gray-800">
