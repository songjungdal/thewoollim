      ...
      <main className="flex-1">
        ...
        <section className="bg-brand-lightgray py-24 px-6 border-b border-gray-100">
          <div className="max-w-4xl mx-auto pt-10">
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-8">환불규정</h1>
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-gray-600 leading-relaxed font-medium text-lg md:text-xl">
              <div className="bg-red-50 border border-red-100 p-8 rounded-3xl mb-16 flex items-start gap-4">
                <AlertCircle className="text-red-500 mt-1 flex-shrink-0" size={24} />
                <div>
                  <h3 className="text-red-900 font-bold mb-2">꼭 확인해주세요!</h3>
                  <p className="text-red-800 text-base">파티 매칭 확정 이후에는 스케줄 조율 및 노쇼 방지를 위해 환불이 제한될 수 있습니다.</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 text-gray-900">
                      <RefreshCw className="text-brand-point" size={24} />
                      <h2 className="text-2xl font-bold">취소 시기별 환불 안내</h2>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 text-gray-900">
                      <CreditCard className="text-brand-point" size={24} />
                      <h2 className="text-2xl font-bold">환불 방법</h2>
                    </div>
                    <p className="text-base text-gray-700">여기에 내용을 입력하세요. 신용카드 결제 시 카드사에 따라 영업일 기준 3~5일이 소요될 수 있습니다. 무통장 입금의 경우 신청하신 계좌로 영업일 기준 2일 이내에 송금됩니다.</p>
                  </div>
                </div>

                <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100">
                  <h2 className="text-2xl font-bold text-gray-900 mb-6">환불 예외 규정</h2>
