      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden py-14 md:py-24 px-4 md:px-6 border-b border-gray-100">
          ...
          <div className="relative z-10 max-w-4xl mx-auto pt-6 md:pt-10">
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-5 md:mb-8">신고센터</h1>
            ...
            <div className="text-gray-600 leading-relaxed font-medium text-base md:text-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mb-12 md:mb-20">
                <div className="p-6 md:p-8 bg-gray-50 rounded-2xl md:rounded-3xl border border-gray-100">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3">완벽한 익명성</h3>
                  <p className="text-sm md:text-base">신고자의 신원은 어떠한 경우에도 피신고자에게 공개되지 않습니다.</p>
                </div>
                <div className="p-6 md:p-8 bg-gray-50 rounded-2xl md:rounded-3xl border border-gray-100">
                  <UserCheck className="text-brand-point mb-4 md:mb-6" size={28} />
                  <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3">철저한 사실 확인</h3>
                  <p className="text-sm md:text-base">운영팀에서 양측의 의견을 종합적으로 검토하여 공정하게 판단합니다.</p>
                </div>
                <div className="p-6 md:p-8 bg-gray-50 rounded-2xl md:rounded-3xl border border-gray-100">
                  <ShieldAlert className="text-brand-point mb-4 md:mb-6" size={28} />
                  <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3">엄격한 패널티</h3>
                  <p className="text-sm md:text-base">사실로 확인될 경우 경고, 이용 정지, 영구 제명 등의 조치가 취해집니다.</p>
                </div>
              </div>

              <div className="bg-brand-black text-white p-7 md:p-12 rounded-2xl md:rounded-[3rem]">
                <h3 className="text-xl md:text-2xl font-black mb-5 md:mb-6">신고 프로세스</h3>
                <ol className="space-y-4 md:space-y-6 list-decimal pl-5 md:pl-6 text-gray-300 text-sm md:text-base">
