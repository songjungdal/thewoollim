        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-gray-900 leading-relaxed font-medium text-lg md:text-xl space-y-16">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">1. 수집하는 개인정보 항목</h2>
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">2. 개인정보의 수집 및 이용목적</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">3. 개인정보의 보유 및 이용기간</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">4. 개인정보의 파기절차 및 방법</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">5. 이용자 및 법정대리인의 권리와 그 행사방법</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">6. 개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항</h2>
                <div className="space-y-4 text-gray-800">
              ...
              <section>
                <h2 className="text-2xl font-black text-black mb-6">7. 개인정보 보호책임자</h2>
                <div className="space-y-4 text-gray-800">
